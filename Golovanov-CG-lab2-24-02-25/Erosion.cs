...
{
    internal class Erosion:Morphling
    {
        public Erosion(Segment mode = Segment.Cube, int sz = 3) :base(mode, sz)
        {
        ...
        public override Color CalculateNewPixelColor(Bitmap image, int x, int y)
        {
            ...
            return Color.FromArgb(redChanel.Min(), greenChanel.Min(), blueChanel.Min());
        }
    }
}
